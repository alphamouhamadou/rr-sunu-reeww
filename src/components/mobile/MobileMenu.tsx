...
export function MobileMenu({ isOpen, onClose, onLogoutClick }: MobileMenuProps) {
  ...
  const navItems = member 
    ? baseNavItems 
    : [...baseNavItems.slice(0, 3), joinItem, baseNavItems[3]]
            ...
            <>
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <p className="text-xs text-gray-500">Gérer votre compte</p>
                </div>
              ...
              <button
                ...
                className="w-full flex items-center gap-4 p-3 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors min-h-[56px]"
              >
